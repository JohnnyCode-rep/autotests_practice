...
class AccountPage(MainPage):
    def should_be_change_password_form(self):
        assert self.is_element_present(*AccountPageLocators.CHANGE_PASSWORD_OLD_PASSWORD), \
            "Old password input field is not found!"
        assert self.is_element_present(*AccountPageLocators.CHANGE_PASSWORD_NEW_PASSWORD), \
            "New password input field is not found!"
        assert self.is_element_present(*AccountPageLocators.CHANGE_PASSWORD_CONFIRM_PASSWORD), \
            "Confirm password input field is not found!"
        assert self.is_element_present(*AccountPageLocators.CHANGE_PASSWORD_BUTTON), \
            "Change password button is not found!"
